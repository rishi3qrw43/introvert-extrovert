...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P('Two things have to hold for the effect to appear. The classes have to be imbalanced enough for SMOTE to generate a large number of synthetic rows, which is why the Kaggle dataset shows almost nothing at 51/49 while MIES shows 20 points at 61/14/25. A logistic regression on seven features has seven coefficients and cannot fit an individual row, which is why it gains 5.65 points where the random forest gains 20.61.'),
      P('For comparison, Fieri et al. [13] report 73.5% before resampling and 95.5% after.'),
