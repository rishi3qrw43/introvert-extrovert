...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P('The second is that the ablation curve in Figure 3 stays flat as items are dropped one at a time, from seven questions down to two. If the last two questions do about as well as all seven, then the choice of questions carries very little information. That is what the null result in Section F would predict.'),
