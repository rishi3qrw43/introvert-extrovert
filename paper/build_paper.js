...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      H2('C. Motivation and Contributions'),
      ...
      BULLET('A controlled comparison in which each of the four decisions is isolated, with the datasets, the models, and the evaluation protocol held fixed, so that any difference is attributable to the decision alone.'),
